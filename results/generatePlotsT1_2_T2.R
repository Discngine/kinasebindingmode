...
ggsave(file="tanimoto_top_mfp1_t1_2_t2.eps", plot=topt, width=15, height=15)
ggsave(file="tanimoto_proba_mfp1_t1_2_t2.eps", plot=proba, width=15, height=15)

ggsave(file="ergfp_t1_2_t2.eps", plot=erg, width=12, height=8)
