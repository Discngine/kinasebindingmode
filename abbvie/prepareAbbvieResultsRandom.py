...
o=open("abbvie_stats_I_II_random.csv","w")
...
for cycle in range(10):
    ...
    responseType1=np.array(getRandomSet(abv_type1_fp,["type1","type2"]))
...
#print(np.sum(np.array(responseType2)=="type1")," FP")
    ...
    responseType2=np.array(getRandomSet(abv_type2_fp,["type1","type2"]))
