...
p=ggplot(mfp3, aes(x=cutoff, y=type1_mean)) + 
  ...
  geom_errorbar(data=mfp3,aes(ymin=type1_mean-type1_sd, ymax=type1_mean+type1_sd,colour='Type I'),position=position_jitter(width=0.001),size=0.1) +
  geom_line(aes(y=type2_mean,ymin=0.7,ymax=1.0,colour='Type II'),size=2)+
  geom_errorbar(data=mfp3,aes(ymin=type2_mean-type2_sd, ymax=type2_mean+type2_sd,colour='Type II'),position=position_jitter(width=0.001),size=0.1) +
  geom_line(aes(y=type1_2_mean,ymin=0.7,ymax=1.0,colour='Type I 1/2'),size=2)+
  geom_errorbar(data=mfp3,aes(ymin=type1_2_mean-type1_2_sd, ymax=type1_2_mean+type1_2_sd,colour='Type I 1/2'),position=position_jitter(width=0.001),size=0.1) +
  labs(y = "MCC",
...
p=ggplot(mfp2, aes(x=cutoff, y=type1_mean)) + 
  geom_line(aes(ymin=0.7,ymax=1.0,colour='Type I'),size=2)+
  geom_errorbar(data=mfp2,aes(ymin=type1_mean-type1_sd, ymax=type1_mean+type1_sd,colour='Type I'),position=position_jitter(width=0.001),size=0.01) +
  geom_line(aes(y=type2_mean,ymin=0.7,ymax=1.0,colour='Type II'),size=2)+
  geom_errorbar(data=mfp2,aes(ymin=type2_mean-type2_sd, ymax=type2_mean+type2_sd,colour='Type II'),position=position_jitter(width=0.001),size=0.01) +
  geom_line(aes(y=type1_2_mean,ymin=0.7,ymax=1.0,colour='Type I 1/2'),size=2)+
  geom_errorbar(data=mfp2,aes(ymin=type1_2_mean-type1_2_sd, ymax=type1_2_mean+type1_2_sd,colour='Type I 1/2'),position=position_jitter(width=0.001),size=0.01) +
  labs(y = "MCC",
                x = "Similarity Threshold",colour="",title="Tanimoto Similarity MFP2") + 
                scale_colour_Publication2() +  
                theme_Publication() + 
                scale_y_continuous(breaks=seq(0.4,1.0,0.1),limits=c(0.4,1.0)) +
                scale_x_continuous(breaks=seq(0.3,1.0,0.1),limits=c(0.3,1.0)) +
